...
<body>
        ...
        if($result){
            while($row=mysqli_fetch_assoc($result)){
                ...
                <td>'.$section.'</td>
                <td>
                <button class="enroll" style="float:center"><span><a href="enrollment.php? enroll='.$subid.'"class="link">Enroll</a></span></button>
                <button class="cancel" style="float:center"><span><a href="cancel.php? enroll='.$subid.'"class="link">Cancel</a></span></button>
                </td>
            </tr>';
            }
        }
